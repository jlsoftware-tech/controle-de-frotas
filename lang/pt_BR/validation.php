...
return [
    ...
    | as regras de tamanho. Sinta-se à vontade para ajustar cada mensagem aqui.
    |
    */
    ...
    | especificar uma linha de linguagem personalizada específica para uma regra.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar o placeholder de
    | atributo por algo mais amigável ao leitor, como "e-mail" em vez de
    | "email". Isso nos ajuda a tornar a mensagem mais expressiva.
    |
    */
    ...
    'attributes' => [
        ...
        // Atributos específicos do sistema de frotas
